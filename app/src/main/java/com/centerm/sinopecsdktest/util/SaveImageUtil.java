package com.centerm.sinopecsdktest.util;
...
//        saveImage(bmp);
    ...
    public static void saveImage(Bitmap bitmap) {
        ...
        String fold = Environment.getExternalStoragePublicDirectory("POS_IMAGE").getAbsolutePath()+ "/scan/";
        File file = new File(fold, thumbPath);
        Log.e("TAG", "saveImage-path:" + file.getAbsolutePath());
